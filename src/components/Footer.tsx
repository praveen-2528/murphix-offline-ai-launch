      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="animate-slide-up [animation-delay:0.4s]">
            ...
            <ul className="space-y-2 text-slate-400">
              <li><a href="#" className="hover:text-white transition-all duration-300 hover:translate-x-1">Documentation</a></li>
              <li><a href="#" className="hover:text-white transition-all duration-300 hover:translate-x-1">Help Center</a></li>
              <li><a href="#" className="hover:text-white transition-all duration-300 hover:translate-x-1">Contact Us</a></li>
        ...
        <div className="border-t border-white/20 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center animate-fade-in [animation-delay:0.6s]">
          ...
          <div className="flex space-x-6 mt-4 md:mt-0">
            ...
            <a href="#" className="text-slate-400 hover:text-white text-sm transition-all duration-300 hover:scale-105">Terms of Service</a>
          </div>
        </div>
      </div>
    </footer>
